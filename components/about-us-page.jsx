...
import { Heart, Users, Zap, Camera, Video, Palette, Share2, Instagram, Briefcase } from "lucide-react"
    ...
    (<div className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
      <header className="relative bg-purple-900 text-white py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">About Nzuri Media Agency</h1>
          <p className="text-xl max-w-3xl mx-auto">
            Empowering brands through creative excellence and strategic innovation
          </p>
        </div>
      </header>
      <main className="container mx-auto px-4 py-16">
        <section className="mb-20">
          <h2 className="text-3xl font-bold mb-8 text-center text-purple-800">Our Story</h2>
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <p className="text-lg mb-4">
                Founded in 2015, Nzuri Media Agency emerged from a passion for creativity and a vision to transform the media landscape in East Africa. Our journey began with a small team of dedicated professionals who believed in the power of innovative storytelling and strategic branding.
              </p>
              <p className="text-lg mb-4">
                Over the years, we've grown into a full-service agency, expanding our expertise across various media disciplines. Our commitment to excellence and our client-centric approach have allowed us to build lasting partnerships with brands across diverse industries.
              </p>
              <p className="text-lg">
                Today, Nzuri Media Agency stands as a beacon of creativity and strategic thinking, continuously pushing boundaries and setting new standards in the world of media and marketing.
              </p>
            </div>
        ...
        <section className="mb-20">
          <h2 className="text-3xl font-bold mb-8 text-center text-purple-800">Our Values</h2>
        ...
        <section className="mb-20">
          <h2 className="text-3xl font-bold mb-8 text-center text-purple-800">Our Expertise</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            <ExpertiseCard icon={<Camera className="w-8 h-8" />} title="Photography" />
            <ExpertiseCard icon={<Video className="w-8 h-8" />} title="Videography" />
            <ExpertiseCard icon={<Palette className="w-8 h-8" />} title="Graphic Design" />
            <ExpertiseCard icon={<Share2 className="w-8 h-8" />} title="Brand Promotions" />
            <ExpertiseCard icon={<Instagram className="w-8 h-8" />} title="Social Media" />
            <ExpertiseCard icon={<Briefcase className="w-8 h-8" />} title="Branding" />
          </div>
        </section>
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold mb-4 text-purple-800">Ready to Work with Us?</h2>
